...
export const campMainnet = defineChain({
  ...
  rpcUrls: {
    default: { http: ["https://rpc-campnetwork.xyz", "https://rpc.basecamp.t.raas.gelato.cloud"] },
    public:  { http: ["https://rpc-campnetwork.xyz", "https://rpc.basecamp.t.raas.gelato.cloud"] },
  },
  blockExplorers: {
